...
function analisar () {
    ...
    if (insNumero(num.value) && !insLista(num.value, valores)){
        ...
        alert (' O valor ja foi inserido ou invalido')
    }
...
function finalizar ( ) {
    ...
    res.innerHTML += `<p> Os valores digitado na ordem foram ${valores.join(' - ')}`
    res.innerHTML += `<p> Os valores digitado na ordem crescente ${valores.sort((a,b) => a - b )}`
